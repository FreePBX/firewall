									...
									<div class="fpbx-container">
										<div class="element-container">
											<div class="">
												<div class="row form-group">
													<div class="col-md-7">
														<label class="control-label" for="INTRUSION_DETECTION_SERVICE">
															<?php echo _("Intrusion Detection Service") ?>
														</label>
														<i class="fa fa-question-circle fpbx-help-icon"
															data-for="INTRUSION_DETECTION_SERVICE"></i>&nbsp;
														<a href="#" data-for="INTRUSION_DETECTION_SERVICE" data-type="bool"
															data-defval="1" class="hidden defset"><i
																class="fa fa-refresh"></i></a>
													</div>
													<div class="col-md-5 radioset text-right">
														<input type="hidden" id="INTRUSION_DETECTION_SERVICEdefault"
															value="1">
														<input type="radio" class="advsetting"
															id="INTRUSION_DETECTION_SERVICEtrue" name="id_service"
															value="enabled" <?php echo $id_service_enabled ?>>
														<label for="INTRUSION_DETECTION_SERVICEtrue">
															<?php echo _("Enabled") ?>
														</label>
														<input type="radio" class="advsetting"
															id="INTRUSION_DETECTION_SERVICEfalse" name="id_service"
															value="diabled" <?php echo $id_service_disabled ?>>
														<label for="INTRUSION_DETECTION_SERVICEfalse">
															<?php echo _("Disabled") ?>
														</label>
													</div>
												</div>
												<div class="row">
													<div class="col-md-12">
														<span id="INTRUSION_DETECTION_SERVICE-help"
										...
										<div class="element-container">
											<div class="">
												<div class="row form-group">
													<div class="col-md-7">
														<label class="control-label" for="IDSF">
															<?php echo _("Intrusion Detection Sync Firewall") ?>
														</label>
														<i class="fa fa-question-circle fpbx-help-icon"
															data-for="IDSF"></i>&nbsp;
														<a href="#" data-for="IDSF" data-type="bool" data-defval="1"
															class="hidden defset"><i class="fa fa-refresh"></i></a>
													</div>
													<div class="col-md-5 radioset text-right">
														<input type="hidden" id="IDSFdefault" value="1">
														<input type="radio" class="advsetting" id="IDSFtrue"
															name="id_sync_fw" value="enabled" <?php echo $id_sync_fw_enabled ?>>
														<label for="IDSFtrue">
															<?php echo _("Enabled") ?>
														</label>
														<input type="radio" class="advsetting" id="IDSFfalse"
															name="id_sync_fw" value="legacy" <?php echo $id_sync_fw_legacy ?>>
														<label for="IDSFfalse">
															<?php echo _("Legacy") ?>
														</label>
													</div>
...
<form class="fpbx-submit" method="post" action="">
	...
	<div class="element-container">
		<div class="">
			<div class="row form-group">
				<div class="col-md-3">
					<label class="control-label" for="sw">
						<?php echo _("Status") ?>
					</label>
				</div>
				<div class="col-md-9">
	...
	<div class="element-container">
		<div class="">
			<div class="row form-group">
				<div class="col-md-3">
					<label class="control-label" for="idwrap">
						<?php echo _("Intrusion Detection") ?>
					</label>
		...
		<div class="row">
			<div class="col-md-12">
				<span id="idwrap-help" class="help-block fpbx-help-block">
					<?php echo _("Control intrusion detection.") ?>
				</span>
			</div>
		</div>
	</div>
	...
	<div class="element-container" ' . $idstatus . '>
		<div class="">
			<div class="row form-group">
				...
				<div class="col-md-9">
					<textarea class="form-control" pattern="' . $wl_filter . '" id="whitelist" name="whitelist" rows="' . (is_array($ids['fail2ban_whitelist'] ?? []) ? count($ids['fail2ban_whitelist'] ?? []) : 0 + 3) . '"">' . ($ids['fail2ban_whitelist'] ?? '') . '</textarea>
				</div>
			</div>
		</div>
		<p></p>
